...
typedef enum
{
  ...
  OWLEY_START_ID = 0,
  OWLEY_STOP_ID,
  OWLEY_SEND_FRAME_DWNL_ID,
  OWLEY_SEND_BIT_ID,
  OWLEY_SEND_OOB_ID,
  OWLEY_SET_STD_ID,
  OWLEY_START_CONTINUOUS_ID,
  OWLEY_STOP_CONTINUOUS_ID,
  OWLEY_GET_VERSION_ID,
  OWLEY_GET_DEVICE_ID,
  OWLEY_GET_INIT_PAC_ID,
  OWLEY_SET_RCSYNC_PERIOD_ID,
  OWLEY_API_TEST_MODE_ID,
  OWLEY_API_MONARCH_TEST_MODE_ID,
  OWLEY_API_MONARCH_TEST_EXEC_RC_SCAN_ID,
  OWLEY_API_MONARCH_STOP_RC_SCAN_ID,
  OWLEY_EE_READ_ID,
  OWLEY_EE_WRITE_ID,
  OWLEY_INFO_INIT_ID,
  /* NotifAck */
  OWLEY_MONARCH_RC_SCAN_CB_ID,
  OWLEY_GET_BATTERY_LEVEL_CB_ID,
  OWLEY_GET_TEMPERATURE_LEVEL_CB_ID,
