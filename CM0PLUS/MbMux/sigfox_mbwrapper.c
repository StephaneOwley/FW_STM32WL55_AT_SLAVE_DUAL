...
void Process_Sigfox_Cmd(MBMUX_ComParam_t *ComObj)
{
  ...
  switch (ComObj->MsgId)
  {
    ...
    case SIGFOX_START_CONTINUOUS_ID:
    	/* USER CODE BEGIN CONT 1*/
    	// Correction Bug transmission CW
